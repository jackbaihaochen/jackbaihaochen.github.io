...
export default function JsonYaml() {
  ...
  return (
    <Space direction="vertical" size="large" style={{ display: 'flex' }}>
      <HelmetProvider>
        <Helmet>
          <title>{t('jsonyaml.seoTitle')}</title>
          <meta name="description" content={t('jsonyaml.seoDescription')} />
          <meta name="keywords" content={t('jsonyaml.keywords')} />
          <link rel="canonical" href="https://jackbaihaochen.github.io/tools/json-yaml/" />
          <link rel="alternate" href={`https://jackbaihaochen.github.io/tools/json-yaml/?lang=zh`} hreflang="zh-CN" />
          <link rel="alternate" href={`https://jackbaihaochen.github.io/tools/json-yaml/?lang=en`} hreflang="en" />
          <link rel="alternate" href={`https://jackbaihaochen.github.io/tools/json-yaml/?lang=ja`} hreflang="ja" />
          <link rel="alternate" href={`https://jackbaihaochen.github.io/tools/json-yaml/`} hreflang="x-default" />
          {/* Open Graph / Twitter */}
          <meta property="og:type" content="website" />
          <meta property="og:title" content={t('jsonyaml.seoTitle')} />
          <meta property="og:description" content={t('jsonyaml.seoDescription')} />
          ...
          <meta name="twitter:title" content={t('jsonyaml.seoTitle')} />
          <meta name="twitter:description" content={t('jsonyaml.seoDescription')} />
