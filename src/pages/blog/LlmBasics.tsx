...
const CANONICAL = 'https://jackbaihaochen.github.io/blog/llm-intro/';
...
export default function LlmBasics() {
  ...
  const article = t('articles.llmBasics', { returnObjects: true }) as ArticleContent;
  const post = t('blog.articles.llmBasics', { returnObjects: true }) as BlogPost;
